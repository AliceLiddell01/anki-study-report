...
| [Operations `O`](operations/README.md) | защищённые admin-инструменты telemetry | O1.1–O1.5 integrated; not deployed | O1.6 verification/runbook только отдельным scope |
