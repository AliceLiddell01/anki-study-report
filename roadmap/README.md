...
| [Operations `O`](operations/README.md) | защищённые admin-инструменты telemetry | O1.1–O1.4 integrated; not deployed | O1.5 minimal Admin Console только отдельным scope |
