...
from gamification_sim.core_economy_screening_v4 import (
    EXPECTED_DIGESTS,
...
def test_frozen_v4_digests_and_strict_schemas_are_exact(
    artifacts: tuple[
        dict[str, Any],
        dict[str, Any],
        dict[str, Any],
...
def test_run_manifest_binds_publication_head_and_v4_digests(
    artifacts: tuple[
        dict[str, Any],
        dict[str, Any],
        dict[str, Any],
