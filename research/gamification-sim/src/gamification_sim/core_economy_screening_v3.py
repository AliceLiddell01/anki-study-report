...
from .core_economy_protocol_v3 import (
    EPSILON,
    LEARN_LIMITATION,
    MATRIX_PATH,
    PIPELINE_PATH,
...
EVALUATOR_VERSION = "core-economy-screening-v3-evaluator-1"
PUBLICATION_SHA = "aa8d119ad5896267f46d9eb644392de11c0e32a2"
EXPECTED_DIGESTS = {
...
MANIFEST_PATH = Path("results/core-economy-screening-manifest-v3.json")
RESULTS_PATH = Path("results/core-economy-screening-results-v3.json")
MANIFEST_SCHEMA_PATH = Path("schemas/core-economy-screening-manifest-v3.schema.json")
RESULTS_SCHEMA_PATH = Path("schemas/core-economy-screening-results-v3.schema.json")
...
def _load_artifacts(
    ...
    _require(observed == EXPECTED_DIGESTS, f"v3 digest mismatch: {observed}")
...
def _source_boundary_proof(repository_root: Path) -> str:
    path = repository_root / "research" / "gamification-sim" / "src" / "gamification_sim" / "core_economy_screening_v3.py"
...
def build_manifest(
    *,
    ...
    protected_paths = [
        ...
        "research/gamification-sim/src/gamification_sim/core_economy_protocol_v3.py",
    ]
    changed = _git(
        repository_root,
        "diff",
    ...
    _require(not changed, f"published v3 changed after publication: {changed}")
    manifest = {
        "$schema": "../schemas/core-economy-screening-manifest-v3.schema.json",
        "identity": {
...
def run_screening(
    *,
    ...
    payload = {
        "$schema": "../schemas/core-economy-screening-results-v3.schema.json",
        "identity": {
...
def build_manifest_schema() -> dict[str, Any]:
    manifest = {
        ...
        "$id": "https://example.invalid/anki-study-report/core-economy-screening-manifest-v3.schema.json",
        "type": "object",
        "additionalProperties": False,
        "required": [
            "$schema",
        ...
        "properties": {
            "$schema": {"const": "../schemas/core-economy-screening-manifest-v3.schema.json"},
...
def build_results_schema() -> dict[str, Any]:
    ...
    schema = {
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://example.invalid/anki-study-report/core-economy-screening-results-v3.schema.json",
        "type": "object",
        "additionalProperties": False,
        "required": [
            "$schema",
        ...
        "properties": {
            "$schema": {"const": "../schemas/core-economy-screening-results-v3.schema.json"},
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Execute and validate G4.4 exact v3 bounded screening"
    )
