...
export const mockReport: StudyReport = {
  ...
  statisticsHub: {
    ...
    capabilities: { core: "available", fsrs: "available", advanced: "future_not_exposed", providers: [], nativeStatsAction: true },
    fsrs: {
      schemaVersion: 1,
      enabled: true,
      availability: "mixed_configuration",
      configurationCount: 2,
      reviewedCardCount: 720,
      qualifyingReviewCount: 4200,
      mixedConfiguration: true,
      defaultConfigurationId: "cfg-10-demo-a1",
      supportedFeatures: ["overview", "memory", "calibration", "steps", "simulator"],
      limitations: ["current_memory_snapshot", "compatible_configuration_required", "read_only"],
      configurations: [
        { id: "cfg-10-demo-a1", presetId: 10, presetName: "Languages", parameterFingerprint: "a1b2c3d4", parameterVersion: "FSRS-6", defaultDesiredRetention: .9, deckDesiredRetentionOverrides: [{ deckId: 102, desiredRetention: .93 }], learningStepsSeconds: [60, 600], relearningStepsSeconds: [600], shortTermMode: "configured_steps", deckIds: [101, 102], deckNames: ["Japanese", "Japanese::N3"], cardCount: 680, reviewedCardCount: 620, qualifyingReviewCount: 4000, coverage: "available", dataSufficiency: "sufficient" },
        { id: "cfg-20-demo-b2", presetId: 20, presetName: "Science", parameterFingerprint: "b2c3d4e5", parameterVersion: "FSRS-6", defaultDesiredRetention: .88, deckDesiredRetentionOverrides: [], learningStepsSeconds: [], relearningStepsSeconds: [], shortTermMode: "fsrs", deckIds: [201], deckNames: ["Science"], cardCount: 140, reviewedCardCount: 100, qualifyingReviewCount: 200, coverage: "available", dataSufficiency: "preliminary" },
      ],
    },
