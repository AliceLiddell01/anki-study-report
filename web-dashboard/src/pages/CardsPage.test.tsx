...
const response: TriageQueryResponse = {
  schemaVersion: 3, dataset: "automatic", status: "partial", generatedAtMs: 10, totalCount: 2, returnedCount: 2, limit: 100, truncated: false,
  ...
  contentChecks: { status: "profiles_need_review", confirmedProfileCount: 1, needsReviewProfileCount: 2, disabledProfileCount: 0, suggestedProfileCount: 0, evaluatedNoteCount: 1, failedCheckCount: 1, skippedCount: 1, truncated: false, errorCode: null },
  items,
};
