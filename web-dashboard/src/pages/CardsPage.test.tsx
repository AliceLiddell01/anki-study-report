...
const items = [
  { itemId: "card:1001", availability: "available" as const, cardId: "1001", noteId: "2001", deck: { deckId: "3", name: "Japanese::N5" }, noteType: { noteTypeId: "7", name: "Japanese Vocabulary" }, template: { ordinal: 0, name: "Recognition" }, displayText: "【に】（する）", displaySource: "reviewer_front" as const, displayStatus: "available" as const, displayTruncated: false, priority: "high" as const, primaryReasonCode: learningReason.code, reasons: [learningReason, contentReason], sources: ["attention" as const, "profile_checks" as const], cardState: { state: "review" as const, suspended: false, buried: false, flag: 1 }, inspect: { mode: "cards" as const, cardId: "1001" } },
  { itemId: "card:1002", availability: "available" as const, cardId: "1002", noteId: "2002", deck: { deckId: "4", name: "Programming" }, noteType: { noteTypeId: "8", name: "Basic" }, template: { ordinal: 0, name: "Card 1" }, displayText: "", displaySource: "reviewer_front" as const, displayStatus: "media_only" as const, displayTruncated: false, priority: "medium" as const, primaryReasonCode: contentReason.code, reasons: [contentReason], sources: ["profile_checks" as const], cardState: { state: "suspended" as const, suspended: true, buried: false, flag: 0 }, inspect: { mode: "cards" as const, cardId: "1002" } },
];
const response = {
  schemaVersion: 3 as const, dataset: "automatic" as const, status: "partial" as const, generatedAtMs: 10, totalCount: 2, returnedCount: 2, limit: 100, truncated: false,
...
const inspectResponse = { schemaVersion: 2 as const, mode: "cards" as const, requestId: "cards-1", details: { cardId: "1001", noteId: "2001", deckId: "3", deckName: "Japanese::N5", noteTypeId: "7", noteTypeName: "Japanese Vocabulary", templateOrdinal: 0, templateName: "Recognition", displayText: "【に】（する）", displaySource: "reviewer_front" as const, displayStatus: "available" as const, displayTruncated: false, state: "review" as const, due: 1, interval: 10, repetitions: 5, lapses: 1, flag: 1, tagSummary: ["n5"], deck: { deckId: "3", deckName: "Japanese::N5" }, noteType: { noteTypeId: "7", noteTypeName: "Japanese Vocabulary" }, template: { ordinal: 0, name: "Recognition" }, queue: 2, tags: ["n5"], renderedPreview: { renderStatus: "sanitized" as const, frontHtml: "<b>覚える</b>", backHtml: "<b>remember</b>", frontPlainText: "覚える", css: "b{font-weight:700}", mediaRefs: [], cardOrd: 0, cardId: 1001, renderSource: "anki_native" } } };
...
describe("Cards v2 queue and Inspector", () => {
  ...
  it("localizes unavailable fallback in English", async () => {
    ...
    workspaceMock.mockReturnValue({ ...readyWorkspace(), activeId: "card:1002", activeItem: { ...items[1]!, displaySource: "none", displayStatus: "unavailable" } });
    const html = renderToStaticMarkup(<CardsPage report={null} loadState="ready" />);
