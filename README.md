...
- **Gamification:** G4.3 v1 помечен `SUPERSEDED_PRE_EXECUTION`; corrective G4.3 v2 зафиксирован как `FROZEN_PRE_SCREENING`; G4.4 не начат, результаты и production approval отсутствуют.
