...
- [E2E-I4 — cancellation и preflight: финальный closeout](ci/e2e-i4-cancellation-preflight-closeout.md)
...
Новые отчёты не добавляются в `docs/`. Они должны указывать дату/scope, проверенные SHA/run identities, честный список непроверенного и ссылку на актуальный контракт в `docs/`.
