> **Archive status:** `HISTORICAL_ONLY`
> **Frozen source:** `48298d02c6871df0ffa112d862d9b2af629c523f:docs/gamification/stage-5-review-simulation-closure.md`
> **Reproduction status:** outputs, numerical results and digests were not reproduced in G0.4
> **Precedence:** the later calibration correction overrides conflicting COMPLETE-era claims
